        ...
        <div>
          ...
          <div style={{ marginTop: '1rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '.55rem' }}>
              <a href="https://www.facebook.com/profile.php?id=61559439638204&mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="footer-social-link">
              ...
              <a href="https://www.instagram.com/mithila_maa?igsh=NTc4MTIwNjQ2YQ%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="footer-social-link">
              ...
              <a href="https://www.youtube.com/@MAAAdmin-s8y" target="_blank" rel="noopener noreferrer" className="footer-social-link">
