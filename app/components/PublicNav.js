...
export default function PublicNav({ active, onInquiry, rightContent }) {
    ...
    <>
      <nav className="pub-nav">
        <div className="pub-nav-inner">
          ...
          {/* Optional right content (e.g. page stats) — desktop only */}
          {rightContent && (
            <div className="pub-nav-desktop" style={{ gap: '1rem', marginLeft: '.5rem', borderLeft: '1px solid rgba(255,255,255,.18)', paddingLeft: '1rem' }}>
              {rightContent}
            </div>
          )}
