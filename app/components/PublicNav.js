        ...
        <div className="pub-nav-inner">
          ...
          <div className="pub-nav-brand">
            ...
            <div className="pub-nav-brand-social">
              ...
              <a href="https://www.youtube.com/@MAAAdmin-s8y" target="_blank" rel="noreferrer noopener" aria-label="YouTube" style={{ display:'flex', alignItems:'center', padding:'.25rem', borderRadius:6, opacity:.85 }}>
          ...
          <div className="pub-nav-links pub-nav-desktop">
            ...
            <a href="https://www.youtube.com/@MAAAdmin-s8y" target="_blank" rel="noreferrer noopener" aria-label="YouTube" style={{ display:'flex', alignItems:'center', padding:'.3rem', borderRadius:6, opacity:.8 }}>
