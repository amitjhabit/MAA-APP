...
export default function GalleryPage() {
  ...
  // Sample photos shown when DB gallery is empty
  const samplePhotos = [
    { id: 1, title: 'Chhath Puja 2024', description: 'Annual Chhath Puja celebration at the waterfront', category: 'religious', image_url: 'https://images.unsplash.com/photo-1621351183012-e2f9972dd9bf?w=600&q=80' },
