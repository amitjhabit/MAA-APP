...
export function buildEmailHtml({ receiptNumber, recipientName, amount, amountWords,
  description, paymentMethod, transactionDate, generatedDate, referenceType, logoCid }) {
...
export async function resendExistingReceipt({ sql, receipt, recipientEmail, description, paymentMethod }) {
  try {
